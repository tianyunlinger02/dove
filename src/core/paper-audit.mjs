...
function figurePathLooksPortable(relativePath) {
  ...
  return isSafeProjectRelativePath(relativePath) && !relativePath.startsWith(".paper/") && !relativePath.includes("node_modules/");
}
...
export function queryPaperAudit(root, args = {}) {
  ...
  for (const error of readErrors) {
    addFinding(findings, {
      ...
      suggestedNextCommand: "project:paper.checklist"
    });
  }
  ...
  for (const claim of evidence.unsupportedClaims) {
    addFinding(findings, {
      ...
      claimIds: [claim.id],
      suggestedNextCommand: "project:paper.claim-gate"
    });
  }
  ...
  for (const claim of evidence.weakClaims) {
    addFinding(findings, {
      ...
      claimIds: [claim.id],
      suggestedNextCommand: "project:paper.research"
    });
  }
  ...
  for (const item of evidence.missingSourceRefs) {
    addFinding(findings, {
      ...
      suggestedNextCommand: "project:paper.source"
    });
  }
  ...
  for (const item of evidence.missingNoteRefs) {
    addFinding(findings, {
      ...
      claimIds: [item.claim.id],
      suggestedNextCommand: "project:paper.note"
    });
  }
  ...
  for (const item of evidence.missingCitationRefs) {
    addFinding(findings, {
      ...
      suggestedNextCommand: "project:paper.citations"
    });
  }
  ...
  for (const item of evidence.draftClaimMismatches) {
    addFinding(findings, {
      ...
      claimIds: [item.claim.id],
      suggestedNextCommand: "project:paper.draft"
    });
  }
  ...
  for (const audit of evidence.auditIntegrityFlags) {
    addFinding(findings, {
      ...
      suggestedNextCommand: "project:paper.experiment-audit"
    });
  }
  ...
  for (const bridgeProblem of evidence.claimBridgeProblems) {
    addFinding(findings, {
      ...
      suggestedNextCommand: "project:paper.result-bridge"
    });
  }
  ...
  for (const issue of figureQa.issues ?? []) {
    addFinding(findings, {
      ...
      suggestedNextCommand: "project:paper.figure"
    });
  }
  ...
  for (const concern of openConcerns) {
    addFinding(findings, {
      ...
      suggestedNextCommand: "project:paper.review-loop"
    });
  }
  ...
  if (activeComparisonTargets.length > 0 && (versionComparisons.items ?? []).length === 0) {
    addFinding(findings, {
      ...
      suggestedNextCommand: "project:paper.version-compare"
    });
  }
  ...
  if (workspaceIndex.lifecycle?.boardFamily && workspaceIndex.lifecycle.boardFamily !== "work-unit" && !workspaceIndex.lifecycle.familyIds.includes(workspaceIndex.lifecycle.boardFamily)) {
    addFinding(findings, {
      ...
      suggestedNextCommand: "project:paper.task-graph"
    });
  }
