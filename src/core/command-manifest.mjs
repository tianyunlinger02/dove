...
export const PACKAGE_GENERATED_SUPPORT_PATHS = Object.freeze([
  ...
  ...PROJECT_HOST_IDS.map((hostId) => `${PACKAGE_RESOURCE_ROOT}/${hostId}/${DOVE_RESEARCH_QUALITY_REFERENCE_PATHS[hostId]}`)
]);
...
const SHARED_RESEARCH_RETURN = "Inspected evidence, material change, and unresolved limits; include the next useful action only when it helps the current request.";
