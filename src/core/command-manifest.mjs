...
export const DOVE_CLAUDE_PROJECT_MARKER_PATH = "mcp/dove-claude-project.json";
export const DOVE_CLAUDE_PROJECT_MARKER = Object.freeze({
  version: 1,
  host: "claude"
});
...
const COMMAND_INTERACTION_CONTRACTS = Object.freeze({
...
export const TOOL_INTERACTION_CONTRACTS = Object.freeze({
...
export function toolInteractionFor(name, args = {}) {
...
const RETIRED_COMMAND_SLUGS = Object.freeze([
  "auto", "operator", "review-loop", "orchestrate", "plan", "checklist", "audit", "autonomy-operate", "return",
