...
export function createStarterMarkdown(state) {
  return {
    ...
    [ARTIFACT_PATHS.checklist]: `# Dove mission checklist\n\n## Orchestration\n\n- [ ] Keep \.dove/orchestration/board.json current\n- [ ] Append a handoff after each major role transition\n\n## Mission evidence\n\n- [ ] Declare target artifacts and acceptance evidence\n- [ ] Keep sources, notes, changed files, or validation output linked to the active mission\n- [ ] Keep the workspace index and task packets resumable\n\n## Execution\n\n- [ ] Route paper-specific work through project:dove.paper.* surfaces\n- [ ] Route generic mission work through project:dove.checklist, project:dove.launch, or project:dove.autonomy-operate as appropriate\n\n## Review and return\n\n- [ ] Run the relevant review or audit surface before closure\n- [ ] Confirm return evidence is durable before marking work complete\n`,
