...
export const toolDefinitions = [
  ...
  {
    name: "run_dove_auto",
    description: "Run demand-to-task intake with compact task/auto cards and, after explicit confirmation, bounded foreground iterations until completion or a boundary.",
    inputSchema: {
      type: "object",
