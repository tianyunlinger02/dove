...
export const toolDefinitions = [
  ...
  { name: "query_meta_optimize", description: "Refresh and read the proposal-only meta-optimize frontier, recommendations, and report paths.", inputSchema: { type: "object", properties: {} } },
