...
- `.opencode/commands/dove.paper.orchestrate.md` is the example command: it starts by reading local context, names canonical artifacts, and tells the operator which MCP tools to prefer.
