---
name: dove-paper-outline
description: "Update the paper outline from the current plan and evidence state."
---

# Dove Paper Outline

Update the paper outline from the current plan and evidence state.

## Contract

- Command id: `dove.paper.outline`
- Domain: `paper`
...
2. Read the narrow durable context first when present: `.dove/context/actions/current.json`, `.dove/workspace/index.json`, `.dove/state.json`, `.dove/outline.md`, `.dove/plans`.
3. Prefer the `upsert_outline` MCP tool when available.
