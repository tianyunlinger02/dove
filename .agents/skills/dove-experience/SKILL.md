...
17. Use this as the combined experiment and claim workflow; do not expose separate public experiment or claim-gate slash commands.
18. Make experiment goals, success criteria, result evidence, audit status, and claim impact explicit.
19. Do not create a placeholder experience plan without a real goal, title, idea, or experimentId.
20. Do not promote unsupported results into claims.
