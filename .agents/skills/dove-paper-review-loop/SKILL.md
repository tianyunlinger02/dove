---
name: dove-paper-review-loop
description: "Generate a durable review entry and revision plan."
---

# Dove Paper Review Loop

Generate a durable review entry and revision plan.

## Contract

- Command id: `dove.paper.review-loop`
- Domain: `paper`
...
2. Read the narrow durable context first when present: `.dove/context/actions/current.json`, `.dove/workspace/index.json`, `.dove/state.json`, `.dove/reviews`, `.dove/revision-plans`, `.dove/evidence/index.json`.
3. Prefer the `run_review_loop` MCP tool when available.
