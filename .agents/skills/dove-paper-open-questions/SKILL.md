---
name: dove-paper-open-questions
description: "Inspect unresolved research and review uncertainty."
---

# Dove Paper Open Questions

Inspect unresolved research and review uncertainty.

## Contract

- Command id: `dove.paper.open-questions`
- Domain: `paper`
- Category: `query`
- Policy: `query`
...
2. Read the narrow durable context first when present: `.dove/context/actions/current.json`, `.dove/workspace/index.json`, `.dove/state.json`, `.dove/wiki/navigation.md`, `.dove/reviews/concerns.json`.
3. Prefer the `query_open_questions` MCP tool when available.
