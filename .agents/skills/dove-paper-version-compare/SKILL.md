---
name: dove-paper-version-compare
description: "Compare durable paper versions and preserve lineage."
---

# Dove Paper Version Compare

Compare durable paper versions and preserve lineage.

## Contract

- Command id: `dove.paper.version-compare`
- Domain: `paper`
...
3. Prefer the `compare_versions` MCP tool when available.
