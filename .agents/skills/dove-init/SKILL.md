...
16. There is exactly one level-0 init task; update it instead of creating a second root.
17. Use init only for the global project goal, then route concrete work through `/dove:mission` or `/dove:auto`.
