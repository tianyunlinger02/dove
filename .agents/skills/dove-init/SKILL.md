...
17. There is exactly one level-0 init task; update it instead of creating a second root.
18. Use init only for the global project goal, then route concrete work through `/dove:mission` or `/dove:auto`.
