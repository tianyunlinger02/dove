---
name: dove-paper-init
description: "Initialize the paper-domain research contract and starter workspace."
---

# Dove Paper Init

Initialize the paper-domain research contract and starter workspace.

## Contract

- Command id: `dove.paper.init`
- Domain: `paper`
...
2. Read the narrow durable context first when present: `.dove/context/actions/current.json`, `.dove/workspace/index.json`, `.dove/state.json`, `.dove/manifest.json`.
3. Prefer the `init_project` MCP tool when available.
