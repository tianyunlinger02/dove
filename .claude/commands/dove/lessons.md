---
description: "Read or maintain advisory Lessons themes and their summary."
---

# dove.lessons

Read or maintain advisory Lessons themes and their summary.
...
- **The user explicitly requests remembering, reflection, or durable Lessons maintenance.**
  ...
  2. Use host tools (work; research-document-maintenance). Preserve useful existing structure and maintain supported reusable guidance in the relevant theme under `lessons/`, or create a naturally named Markdown file when a new theme is genuinely useful. Update `lessons/LESSONS.md` with a natural link when needed. Source explanation is optional. Do not create lesson IDs, frontmatter, an application ledger, or treat Lessons as evidence. Maintain Dove research Markdown only when the work creates durable research value.
