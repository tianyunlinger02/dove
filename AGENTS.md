...
- Use `node ./bin/dove.mjs status .` first only when the user asks about Dove state, the next step, blockers, task choice, or whether work should bind to a tracked task.
