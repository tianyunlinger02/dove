...
- Resume command: project:paper.orchestrate
...
- board-next-action: Next action: undefined
- board-current-role: Current role owner is planner.
...
- planner: .paper/context/roles/planner.json
- researcher: .paper/context/roles/researcher.json
- reviewer: .paper/context/roles/reviewer.json
- rebuttal-lead: .paper/context/roles/rebuttal-lead.json
- experiment-planner: .paper/context/roles/experiment-planner.json
- version-analyst: .paper/context/roles/version-analyst.json