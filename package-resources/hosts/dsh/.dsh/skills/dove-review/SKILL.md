...
- DSH has no equivalent recoverable isolated Claude Code context in this package. Use author-side Review or preserve a user-provided returned review; do not present DSH as running `dove review handoff`, `resume`, or `rerun` unless a future host actually exposes equivalent isolation.
