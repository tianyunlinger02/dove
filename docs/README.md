...
- [Usage](USAGE.md) — mission-bound workflow, durable schema 8 artifact model, explicit advisory lesson query/record, read-only status, sealed MCP tools, and responsibility boundaries.
...
- Keep the inventories aligned but distinct: 12 host workflows; separately 16 top-level CLI subcommands, 27 MCP tools, and 60 generated adapters across the four checked-in project hosts plus Claude user commands.
