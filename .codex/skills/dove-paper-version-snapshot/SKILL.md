---
name: dove-paper-version-snapshot
description: "Create an honest paper version snapshot."
---

# Dove Paper Version Snapshot

Create an honest paper version snapshot.

## Contract

- Command id: `dove.paper.version-snapshot`
- Domain: `paper`
...
3. Prefer the `create_version_snapshot` MCP tool when available.
