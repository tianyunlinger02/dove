---
name: dove-paper-checklist
description: "Paper-domain view of the active Dove mission checklist."
---

# Dove Paper Checklist

Paper-domain view of the active Dove mission checklist.

## Contract

- Command id: `dove.paper.checklist`
- Domain: `paper`
- Category: `mutation`
...
2. Read the narrow durable context first when present: `.dove/context/actions/current.json`, `.dove/workspace/index.json`, `.dove/state.json`, `.dove/checklists/current.md`, `.dove/task-packets/index.json`.
