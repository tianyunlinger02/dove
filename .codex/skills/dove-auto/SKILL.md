...
10. Propose the target, work limit, and visible steps before running.
11. Run only in the current approved interaction; never schedule hidden background continuation.
12. For research work, collect real sources or materials before claiming success.
13. Stop clearly at completion, blocker, review need, missing material, or budget limit.
