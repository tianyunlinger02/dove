---
name: dove-paper-governance-audit
description: "Paper-domain view of governance coverage proof."
---

# Dove Paper Governance Audit

Paper-domain view of governance coverage proof.

## Contract

- Command id: `dove.paper.governance-audit`
- Domain: `paper`
- Category: `query`
...
2. Read the narrow durable context first when present: `.dove/context/actions/current.json`, `.dove/workspace/index.json`, `.dove/state.json`, `.dove/meta/governance-coverage.json`.
