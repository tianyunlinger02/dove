...
10. Draft or revise only when body content or a clear section-status change is provided.
11. Use explicit placeholders for missing evidence or citations instead of fabricating support.
12. Use linked sources, notes, experience, figures, and review findings when they are available.
