...
4. Use only the Dove MCP tool matching the requested operation from this command's allowed tools: `normalize_rebuttal_issues`, `build_rebuttal_strategy`, `build_rebuttal`.
...
13. Every issue must link to a current mission-owned review artifact and concrete finding id.
14. Strategy and responses remain author-side and reject stale issues, stale strategy, or missing evidence.
