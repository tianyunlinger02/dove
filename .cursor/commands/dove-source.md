...
- **The user requests source discovery, reading, comparison, or verification.**
  ...
  3. Use host tools (work; source-research). Discover, retrieve, save when useful, read, and verify real material with host-native project or external research tools. Distinguish material merely found from material actually retrieved, inspected, and used.
