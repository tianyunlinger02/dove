...
- **The user requests a figure, diagram, plot, or caption.**
  ...
  4. Use host tools (read-only; figure-validation). Check that the figure is legible and that its labels, caption, and content agree with the actual project material or data. This step is read-only; do not create or modify files.
