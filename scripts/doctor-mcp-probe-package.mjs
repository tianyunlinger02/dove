...
var baseToolDefinitions = [
  ...
  mutationTool("import_review_exchange", "Import one canonical hash-bound schema 8 handoff and report as non-authoritative mission artifacts.", { missionId: safeId, exchangeId: safeId, reviewId: safeId }, ["missionId", "exchangeId", "reviewId"]),
...
async function main() {
  ...
  assert2.deepEqual(listed.tools.map((tool) => tool.name), TOOL_NAMES, "MCP registry drifted from the sealed schema 8 surface");
