...
1. Read `.paper/state.json`, `.paper/orchestration/board.json`, `.paper/evidence/index.json`, `.paper/reviews/log.md`, `.paper/revision-plans/current-plan.md`, and the relevant draft files.
...
3. Convert new findings into blockers or rebuttal issues rather than leaving them only in prose.
