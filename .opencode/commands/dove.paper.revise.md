...
1. Read `.dove/context/actions/current.json` when present, then `.dove/revision-plans/current-plan.md`, `.dove/plans/current-plan.md`, `.dove/checklists/current.md`, `.dove/reviews/log.md`, `.dove/reviews/concerns.json`, and the affected artifacts.
...
5. Route acceptance proof to `project:dove.paper.review-loop`, `project:dove.checklist`, `project:dove.paper.version-snapshot`, or `project:dove.paper.version-compare`.
