...
9. When a ranked packet path is accepted and you want one explicit durable work item instead of another proposal layer, use `project:dove.materialize` / `materialize_guidance_packet` to create a real task packet through the governed bridge.
