...
4. Use the task graph to identify blocked work, stale packets, missing parent/child linkage, and missing linkage between tasks and durable evidence artifacts.
